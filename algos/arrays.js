export const arrays = {
  ...
  stock: (arr) => {
    // Given an array where the number at each index i is the price of a stock on date i, and assuming you may buy once and sell once, return an array containing: a purchase date, a sell date, and the maximum profit you can make using those dates.
  },
  mergeIntervals: (arr) => {
